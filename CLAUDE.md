...
- **`.claude-plugin/marketplace.json`** — Marketplace catalog; users install via `/plugin marketplace add gadenbuie/yap-with-claude` then `/plugin install yap@yap-with-claude`.
